 ...
 */
    ...
    class manualPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('nome_arquivo');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('manualssearch', $this->dataset,
                array('id_descricao', 'id_produto_descricao', 'nome_arquivo', 'descricao'),
                array($this->RenderText('Id'), $this->RenderText('Produto'), $this->RenderText('Nome Arquivo'), $this->RenderText('Descricao')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('manualasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('nome_arquivo', $this->RenderText('Nome Arquivo')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for nome_arquivo field
            //
            $column = new TextViewColumn('nome_arquivo', 'Nome Arquivo', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('manualGrid_nome_arquivo_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('manualGrid_descricao_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('manualGrid_nome_arquivo_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('manualGrid_descricao_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for nome_arquivo field
            //
            $editor = new TextAreaEdit('nome_arquivo_edit', 50, 8);
            $editColumn = new CustomEditColumn('Nome Arquivo', 'nome_arquivo', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        public function GetModalGridDeleteHandler() { return 'manual_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'manualGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('nome_arquivo', 'Nome Arquivo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'manualGrid_nome_arquivo_handler_list', $column);
            ...
            $column = new TextViewColumn('descricao', 'Descricao', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'manualGrid_descricao_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for nome_arquivo field
            //
            $column = new TextViewColumn('nome_arquivo', 'Nome Arquivo', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'manualGrid_nome_arquivo_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for descricao field
            //
            $column = new TextViewColumn('descricao', 'Descricao', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'manualGrid_descricao_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new manualPage("manual.php", "manual", GetCurrentUserGrantForDataSource("manual"), 'UTF-8');
        $Page->SetShortCaption('Manual');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Manual');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("manual"));
