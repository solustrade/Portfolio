 ...
 */
    ...
    class empresaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field = new StringField('tel');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('email');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('whatsapp');
            $this->dataset->AddField($field, false);
        }
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('empresassearch', $this->dataset,
                array('id', 'tel', 'email', 'whatsapp'),
                array($this->RenderText('Id'), $this->RenderText('Telefone'), $this->RenderText('Email'), $this->RenderText('Whatsapp')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('tel', $this->RenderText('Telefone')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('whatsapp', $this->RenderText('Whatsapp')));
        }
        ...
        {
            //
            // View column for tel field
            //
            $column = new TextViewColumn('tel', 'Telefone', $this->dataset);
            ...
            $column->SetFullTextWindowHandlerName('empresaGrid_email_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $column = new TextViewColumn('whatsapp', 'Whatsapp', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('empresaGrid_email_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        {
            //
            // Edit column for tel field
            //
            $editor = new TextEdit('tel_edit');
            $editor->SetSize(20);
            $editor->SetMaxLength(20);
            $editColumn = new CustomEditColumn('Telefone', 'tel', $editor, $this->dataset);
        ...
        protected function CreateGrid()
        {
            ...
            $column = new TextViewColumn('email', 'Email', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'empresaGrid_email_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for email field
            //
            $column = new TextViewColumn('email', 'Email', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'empresaGrid_email_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
