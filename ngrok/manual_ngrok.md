...
Execute o comando abaixo substituindo \<TOKEN\> pelo seu token pessoal:\
...
### 5.2 Expor um Servidor HTTPS

Para expor um servidor local rodando com HTTPS, use:\
ngrok http https://localhost:443

### 5.3 Especificar Subdomínio (contas pagas)
